...
import { IControls, ICameraState, IModelState, ICameraControls, IConnectionControls, IOutputControls, IPoseEstimationControls, IConnectionState } from "../components/typesPose";
import { SliderControl, SwitchControl, DropDownControl } from '../components/UIPose';
