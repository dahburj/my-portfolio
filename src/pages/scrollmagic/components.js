	...
	<ComponentsStyled>
		<div className="section">
			<video
				...
				muted
			>
				<source src={"https://www.marcfehr.ch/tfe/videos/test1.mp4"} type={"video/mp4"} />
			</video>
			<h1 className={'absolute text fat white'}>Jamal Dahbur</h1>
		</div>
		<Controller>
			...
			<Scene duration={'300%'} pin={true} triggerHook={0}>
				<StatelessRef videoURL={'https://www.marcfehr.ch/tfe/videos/test2.mp4'} />
			</Scene>
			<Scene triggerHook={0} duration={'50%'}>
				<div
					style={{
			...
			<Scene duration={'200%'} pin={true} triggerHook={0}>
				<StatelessRef videoURL={'https://www.marcfehr.ch/tfe/videos/test4.mp4'} />
			</Scene>
